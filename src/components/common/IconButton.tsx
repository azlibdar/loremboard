...
const variants = {
  ...
  secondary:
    "bg-white dark:bg-transparent border shadow-sm border-zinc-200 dark:border-zinc-700/80 text-zinc-600 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-800",
